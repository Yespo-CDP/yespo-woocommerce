...
function get_all_users($post)
{
    ...
    $exp_ord = \Yespo\Integrations\Esputnik\Yespo_Order_Mapping::create_bulk_order_export_array($orders);
    var_dump($exp_ord);
...
*/
    ...
    */
    ...
    //$id = (new \Yespo\Integrations\Esputnik\Yespo_Contact())->get_user_id_by_email('test');
    //var_dump($id);
